...
from metaspn import compute_profile, generate_cards, init_repo
    ...
    try:
        ...
        activities_data = [
            ...
            },
            {
                ...
                "content": "In this tutorial, I'll show you step by step how to build a framework. "
                * 200,
                "days_ago": 15,
            },
            {
        ...
        for platform in profile.platforms:
            print(
                f"      - {platform.platform}: {platform.role} ({platform.activity_count} activities)"
            )
