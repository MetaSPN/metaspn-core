...
from metaspn.utils.stats import linear_regression, mean
...
class TrajectoryAnalyzer:
    ...
    def compute(
        ...
        # Filter to window
        window_activities = [a for a in sorted_activities if a.timestamp >= start_date]
    ...
    def predict_next_period(
        ...
        current_count = len([a for a in activities if a.timestamp >= period_start])
